...
```
DAB_Project_102        <- Root directory. Both monorepo and polyrepo are supported.
│
├── DAB_Project_102       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
