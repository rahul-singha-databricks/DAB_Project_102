...
Opening a pull request will trigger a[workflow](../.github/workflows/DAB_Project_102-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/DAB_Project_102/DAB_Project_102-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/DAB_Project_102/DAB_Project_102-model)
. 
