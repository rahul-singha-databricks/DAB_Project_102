...
git add README.md docs .gitignore DAB_Project_102/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[DAB_Project_102/databricks.yml](../DAB_Project_102/databricks.yml) file.
...
Follow the instructions in [DAB_Project_102/resources/README.md](../DAB_Project_102/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../DAB_Project_102/resources/README.md)  to propose, test, and deploy
